...
export default function Hero() {
  return (
    <main
      className="min-h-screen bg-linear-to-br from-slate-950 via-indigo-950 to-slate-950 text-white"
      id="hero"
    >
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-slate-300 mt-6 mb-10 max-w-3xl mx-auto leading-relaxed">
              Stop losing track of your applications. Organize your job search,
              sync your emails, and land your dream role with our intuitive
              tracking system.
            </p>
