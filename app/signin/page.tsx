...
const SignIn = () => {
  return (
      <div className=' w-full h-screen flex flex-col items-center justify-center'>
            ...
            <form action="" method="post" className='min-w-2xl px-8 py-6 shadow-md rounded-lg flex flex-col gap-2 bg-white mb-3'>
              ...
              <div className='flex justify-between align-middle'>
                  ...
                  <Link href="/signup" className='text-blue-600'>Forgot your password?</Link>
               </div>
              <div className='relative'>
        ...
        <button className='rounded w-full border bg-blue-700 text-white p-1 mt-2'>Continue</button>
        ...
        <p className='text-center'>Don't you have an account ? <Link className='text-blue-500' href="/signup">Sign up</Link></p>
            </form>
