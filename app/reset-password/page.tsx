  ...
  return (
       <div className=' w-full h-screen flex flex-col items-center justify-center'>
            ...
            <form action="" method="post" className='min-w-2xl px-8 py-6 shadow-md rounded-lg flex flex-col gap-2 bg-white mb-3'>
              ...
              <button className='bg-blue-500 hover:bg-blue-700 text-white rounded p-2 mt-2 cursor-pointer'>Send reset link</button>
            <Link className='text-blue-700 text-center mt-2 hover:text-blue-500' href="/signin"> ← Back to Login</Link>
            </form> 
          </div>
  )
}
