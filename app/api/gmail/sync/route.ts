...
import { gmail, oauth2Client } from "@/app/lib/gmail";
import { extractPlainText } from "@/app/lib/gmail-utils";
...
export async function POST() {
  ...
  do {
    ...
    const date = internalDateMs ? new Date(internalDateMs).toISOString().split('T')[0] : null;
